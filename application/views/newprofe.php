				...
				<h1>FITXA DEL PROFESSORAT
					<small>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> COGNOMS: </label>
							<input type="text" id="form-field-1" placeholder="Cognoms" class="col-xs-10 col-sm-3" />
						</div>
						<!--COGNOMS FIN-->
						<!--NOM-->
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> NOM: </label>
							<input type="text" id="form-field-1" placeholder="Nom" class="col-xs-10 col-sm-3" />
						</div>
						<!--NOM FIN-->
						<!--NIF-->
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> NIF: </label>		<input type="text" id="form-field-1" placeholder="Nif" class="col-xs-10 col-sm-3 input-mask-dni" />
						</div>
						<!--NIF FIN-->
						<!--DATA DE NAIXEMENT-->
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> DATA DE NAIXEMENT: </label>
							<div class="row">
						...
						<!--DATA DE NAIXEMENT FIN-->
						<!--MUNICIPI I PROVINCIA DE NAIXEMENT-->
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">MUNICIPI I PROVINCIA DE NAIXEMENT: </label>
						...
						<!--MUNICIPI I PROVINCIA DE NAIXEMENT FIN-->
						<!--ADREÇA-->
						<div class="form-group">
						...
						<div class="form-group">
							...
							<select class="col-xs-10 col-sm-3 chosen-select" id="form-field-select-3" data-placeholder="Sel·lecciona" >
								...
								<option value="AL">43612</option>
								<option value="JE">43001</option>
							</select>
						</div>
						<!--MUNICIPI I CP FIN-->
						<!--TELEFON I CORREU-->
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('.input-mask-telefon').mask('999-99-99-99');
